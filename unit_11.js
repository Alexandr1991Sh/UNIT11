...
function f2() {
    document.querySelector('.out-2').innerHTML = d1.pop()
    showArr('.out-2', d1);
}
...
function f3() {
    document.querySelector('.out-3').innerHTML = d1.shift()
    showArr('.out-3', d1);
}
...
function f4() {
    ...
    document.querySelector('.out-4').innerHTML = d1;
    showArr('.out-4', d1);
}
...
function f5() {
    ...
    document.querySelector('.out-5').innerHTML = d1;
    showArr('.out-5', d1);
}
...
function f15() {
    ...
    if (d15.indexOf != (input)) d15.push(input);
...
function f19() {
    for (i = 0; i < d19.length; i++) {
        if (d19[i].length > maxString.length) maxString = d19[i];
    }
